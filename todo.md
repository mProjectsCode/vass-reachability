...
- [x] Extend the (partial bc we looked only at the visited subgraph) SCCs in the MGTS by adding more edges that weren't visited

- [ ] Build a data structure represents the product of a subset of automatons in an implicit product. We would use this to more easily ignore the counting cfg and to ignore/sleep certain MGTS
